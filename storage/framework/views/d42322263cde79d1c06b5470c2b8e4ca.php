...
<div class="regis">
<div class="container">
            <form class="login-email" method="POST" action="<?php echo e(route('register')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\NEW\WarungIrfan\resources\views/auth/register.blade.php ENDPATH**/ ?>