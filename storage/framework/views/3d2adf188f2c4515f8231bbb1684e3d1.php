                    ...
                    <form action="<?php echo e(url('update-menu/'.$menu->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" value="<?php echo e($menu->original_price); ?>" name='original_price'>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="">menu Price</label>
                                <input type="number" class="form-control" value="<?php echo e($menu->menu_price); ?>" name='menu_price'>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="">Delivery Days</label>
                                <input type="number" class="form-control" value="<?php echo e($menu->delivery_days); ?>" name='delivery_days'>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">Tax</label>
                                <input type="number" class="form-control" value="<?php echo e($menu->tax); ?>" name='tax'>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">Revisions</label>
                                <input type="number" class="form-control" value="<?php echo e($menu->qty); ?>" name='qty'>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12">
                                <?php if($menu->image): ?>
                                <img src="<?php echo e(asset('assets/uploads/menu/'.$menu->image)); ?>" alt="menu Image">
                            <?php endif; ?>
                            </div>
                            <div class="col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\NEW\WarungIrfan - Copy\resources\views/admin/menu/edit.blade.php ENDPATH**/ ?>