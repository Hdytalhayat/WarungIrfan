                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <?php if($categories->image): ?>
                                    <img src="<?php echo e(asset('assets/uploads/categories/'.$categories->image)); ?>" alt="Categories Image">
                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\NEW\WarungIrfan - Copy\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>