            ...
            <div class="card-body">
                <div class="row menu_data">
                    ...
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            {{ $menu->name }}
                            <label style="font-size: 16px" class="float-end badge bg-danger trending_tag">{{ $menu->trending == '1'?'Promo':'' }}</label>
                        </h2>
                        <hr>
                        <label for="" class="me-3">Original Price : <s>Rp. {{ $menu->original_price }}</s> </label>
                        <label style="font-weight: bold" class="me-3">menu Price : Rp. {{ $menu->menu_price }} </label>
                        <hr>
                        @php
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-9">
                                ...
                                <button type="button" class="btn btn-primary me-3 float-start"><a class="text-white" href="{{ url('qrcode/'.$menu->id) }}">Scan QR<i class="fa fa-qr"></i></a></button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="col-md-12">
                                ...
                                <a href="{{ url('review/'.$menu->slug.'/user-review') }}" class="btn btn-link" >
