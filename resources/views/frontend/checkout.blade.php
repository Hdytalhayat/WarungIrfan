                        ...
                        <div class="card-body">
                            ...
                            <div class="row checkout-form">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ Auth::user()->name }}" name="fname" type="text" class="form-control fname" placeholder="Enter First Name">
                                    <span id="fname_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Last Name</label>
                                    <input value="{{ Auth::user()->last_name }}" name="lname" type="text" class="form-control lname" placeholder="Enter Last Name">
